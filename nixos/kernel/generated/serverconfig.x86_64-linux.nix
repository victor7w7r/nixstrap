{
  ...
  "CONFIG_CMDLINE" = "vt.default_red=30,243,166,249,137,245,148,186,88,243,166,249,137,245,148,166 vt.default_grn=30,139,227,226,180,194,226,194,91,139,227,226,180,194,226,173 vt.default_blu=46,168,161,175,250,231,213,222,112,168,161,175,250,231,213,200 pti=on page_alloc.shuffle=1 elevator=none lsm=landlock,yama,integrity,apparmor,bpf page_poison=1 oops=panic randomize_kstack_offset=on iommu=pt pcie_acs_override=downstream,multifunction kvm.ignore_msrs=1 kvm.report_ignored_msrs=0 rcutree.enable_rcu_lazy=1 rcupdate.rcu_expedited=1 threadirqs  split_lock_detect=off tsc=reliable nowatchdog nmi_watchdog=0 libahci.ignore_sss=1 sysrq_always_enabled=0 udev.log_level=3 verbose=1 i915.enable_guc=2 kvm_intel.emulate_invalid_guest_state=0 kvm_intel.nested=1 intel_pstate=disable intel_iommu=on i915.enable_psr=0 acpi_backlight=vendor mem_sleep_default=deep i2c_dw.disable_fast_mode=1 i915.enable_dpcd_backlight=1";

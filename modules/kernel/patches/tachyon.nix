{ inputs, ... }:
{
  ...
  kernel.patches.tachyon =
    pkgs:
    {
      common = map (patch: "${inputs.tachyon-patches}/patches/${patch}.patch") [
        ...
        "0007-sched-fair-Remove-throughput-optimization-that-keeps"
        "0050-Revert-ext4-do-not-create-EA-inode-under-buffer-lock"
        "0067-tcp-bbr3-add-BBRv3-congestion-control"

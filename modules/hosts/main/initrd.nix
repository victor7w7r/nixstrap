    ...
    { lib, pkgs, ... }:
    {
      boot.initrd = {
        ...
        systemd.services = {
          ...
          "systemd-cryptsetup@storage.service".enable = false;
          "systemd-cryptsetup@storagecachecrypt.service".enable = false;
          "systemd-cryptsetup@storagelogcrypt.service".enable = false;
          "systemd-cryptsetup@swapcrypt.service".enable = false;
          setup-storage =
            let

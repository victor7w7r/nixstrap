{ den, ... }:
{
  #nix build -L ".#nixosConfigurations.phone-fajita.config.system.build.toplevel"
  #nix build -L ".#nixosConfigurations.phone-fajita.config.system.build.diskoImagesScript"
